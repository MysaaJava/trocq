...
Section Transfer.
    ...
    Trocq Register I @ (PType map3 map0) ~ I' because Rf.
    ...
    Trocq Register pe @ (PTriple I I' Rf -> PType map0 map1) ~ pe' because Rpe.
    ...
    Trocq Register qe @ (PTriple I I' Rf -> PTriple I I' Rf -> PType map1 map0) ~ qe' because Rqe.
